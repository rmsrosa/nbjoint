...
They would normally fit into a single Jupyter notebook, but that would miss the point of the module, which is to joint several notebooks. Thus, the presentation is split into a number of them.
